...
namespace Sdcb.PaddleOCR.Models.ChineseV6Medium;
...
public static class ChineseV6MediumModel
{
    ...
    private sealed class ProviderImpl(string name, PaddleOcrModelKind kind, string resource, string format) : IPaddleOcrModelProvider
    {
        ...
        public Stream OpenRead() => typeof(ChineseV6MediumModel).Assembly.GetManifestResourceStream("Sdcb.PaddleOCR.Models.ChineseV6Medium." + resource)
