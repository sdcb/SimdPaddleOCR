...
namespace Sdcb.SimdPaddleOCR.Models.ChineseV6Tiny;
...
public static class ChineseV6TinyModel
{
    ...
    private sealed class ProviderImpl(string name, PaddleOcrModelKind kind, string resource, string format) : IPaddleOcrModelProvider
    {
        ...
        public Stream OpenRead() => typeof(ChineseV6TinyModel).Assembly.GetManifestResourceStream("Sdcb.SimdPaddleOCR.Models.ChineseV6Tiny." + resource)
