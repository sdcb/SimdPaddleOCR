...
namespace Sdcb.SimdPaddleOCR.Models.ChineseV6Small;
...
public static class ChineseV6SmallModel
{
    ...
    private sealed class ProviderImpl(string name, PaddleOcrModelKind kind, string resource, string format) : IPaddleOcrModelProvider
    {
        ...
        public Stream OpenRead() => typeof(ChineseV6SmallModel).Assembly.GetManifestResourceStream("Sdcb.SimdPaddleOCR.Models.ChineseV6Small." + resource)
