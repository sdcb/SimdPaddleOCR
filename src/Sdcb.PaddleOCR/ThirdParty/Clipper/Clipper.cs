...
// This port is used only by DB post-processing. Keep the namespace and all
// of its types implementation-internal; none of Clipper's API is part of the
// public PPOCRSharp surface.
namespace ClipperLib
{
    ...
    // Clipper is an implementation detail of DB post-processing; do not expose
    // the third-party implementation (or its exception type) as part of the
    // PPOCRSharp public API.
